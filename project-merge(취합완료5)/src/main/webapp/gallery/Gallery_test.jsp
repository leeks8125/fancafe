...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <script src="./gallery/jquery.masonry.min.js"></script>
    <script src="./gallery/jquery.imagesloaded.min.js"></script>
    <script>
        // 풀다운 메뉴
    ...
    <c:if test="${sessionScope.id != null}">
	    <div class="paper">
	    	<div class="paper-holder"> 
	            <a href="./GalleryForm.dk"><img width="150" height="150" src="./gallery/add.png" /></a> 
	        </div>
	            <p class="paper-description">글쓰기</p> 
	        <div class="paper-content">  
	            <a class="paper-text" href="./GalleryForm.dk">버튼을 클릭하세요</a> 
	        </div>
	    </div>
	</c:if>
    	<c:forEach var="g" items="${boardlist }">
	        <div class="paper"> 
	            <div class="paper-holder"> 
	                <a href="./GalleryDetailAction.dk?no=${g.no}"><img width="150" height="150" src="./galleryupload/${g.fname}" /></a> 
	            </div> 
	            <p class="paper-description">${g.author }</p> 
	            <div class="paper-content">  
	                <a class="paper-text" href="./GalleryDetailAction.dk?no=${g.no}">${g.title }</a> 
	            </div> 
	        </div> 
    	</c:forEach>
